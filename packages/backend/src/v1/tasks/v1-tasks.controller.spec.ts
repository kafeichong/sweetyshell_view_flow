...
describe('V1TasksController v2 workflow API', () => {
  ...
  it('returns the shared contract catalog', () => {
    expect(new V1TasksController(tasks as never, preflight as never, catalog as never, submission as never, taskListService as never).workflows()).toEqual(directory);
  });
  ...
  it('delegates Preview without applying a controller-level Production whitelist gate', async () => {
    ...
    await expect(new V1TasksController(tasks as never, preflight as never, catalog as never, submission as never, taskListService as never)
  ...
  it('delegates preflight recheck and maps a missing record', async () => {
    const controller = new V1TasksController(tasks as never, preflight as never, catalog as never, submission as never, taskListService as never);
  ...
  it('retires Task-based Preview creation with a recognizable upgrade error', async () => {
    await expect(new V1TasksController(tasks as never, preflight as never, catalog as never, submission as never, taskListService as never).create(
