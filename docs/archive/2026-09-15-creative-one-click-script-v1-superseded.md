...
> 归档说明：本文和对应脚本仍发送旧 `capability/profile/params` 与 `mode=preview|production` 协议，已被 [当前脚本状态说明](../runbooks/creative-one-click-script.md)取代。本文只保留历史操作方式，不得用于当前新建任务。
>
> 最后更新：2026-09-11
> 脚本位置：`scripts/seedance_cli_smoke.sh`
> 相关历史文档：[旧创意手册](./2026-09-15-creative-user-guide-v1-superseded.md)、[PROJECT_STATUS.md](../PROJECT_STATUS.md)
...
当时要求先按[旧创意手册](./2026-09-15-creative-user-guide-v1-superseded.md)安装个人 token；本节仅保留历史原意，不得在当前版本照做。
