...
<Tabs>
<Tab zoneid="VEAJnfWoyw" title="基本定义方式">
...
<Tab zoneid="yfQBjKRieG" title="多素材同主体">
...
<Tab zoneid="E2wLubMPpo" title="多主体场景">
...
模型对运镜词理解力很强，直接使用标准运镜术语即可，例如 “中景、特写、全景、缓慢推镜、平稳横移、固定镜头” 。更多请参见 [镜头语言](https://ark.volcengine.com/region:cn-beijing/docs/82379/1631633?lang=zh#afc80793)。
...
<Tabs>
<Tab zoneid="BUjXg5z1gz" title="示例1：宿舍情感短剧（偏文戏 / 对话）">
...
<Tab zoneid="YO4giEynmD" title="示例2：古风悬崖对手戏（偏动作/氛围）">
...
Seedance 2.0 系列模型支持生成常用文字。模型能根据情境**自动匹配**合适的风格与颜色，也支持在提示词中**指定**文字的颜色、风格、出现方式、出现时机、出现位置。编写时请优先使用**常用字**，避免**生僻字**与**特殊符号**，以确保最佳呈现效果。当前支持广告语、字幕、气泡等场景，具体写法和案例请参见[文字生成](https://ark.volcengine.com/region:cn-beijing/docs/82379/2222480?lang=zh#081b2c64)。
...
1. 在提示词中补充细致的音色特征描述，可参考[Seedance 1.5 pro 提示词指南](https://ark.volcengine.com/region:cn-beijing/docs/82379/2168087?lang=zh)。
...
展示在不同场景下使用 Seedance 2.0 系列模型的提示词示例，帮助您更精准地实现全模态参考的指代控制及文字生成等功能。 更多优秀案例请参考 [控制台体验中心 Seedance2.0](https://ark.volcengine.com/region:cn-beijing/experience/vision?modelId=doubao-seedance-2-0-260128&tab=GenVideo) 模板库。
