...
Seedance 2.0 和 Seedance 2.5 系列模型具有完备的防范 Deepfake 和侵犯版权风险能力。在生成视频时，会对有风险的参考素材输入进行拦截，最大限度保证生成视频合规和安全性。

为确保创作者能充分利用 Seedance 强大的视频生成能力高效生成视频内容，同时规避 AI 生成内容的潜在风险，方舟推出了私域可信素材库。完成入库的可信素材将进入您的私域素材库，在视频生成中使用。

私域素材库使用流程如下：

<div style="text-align: center">
<img src="https://arkdoc.tos-cn-beijing.volces.com/images/video-generation/volc_advanced_creative_packs.png" width="3866px" /></div>
...
* <div data-tips="true" data-tips-type="tip">版式：竖版</div>
...
<div data-tips="true" data-tips-type="warning">用户需具备相应的 IAM 权限，具体权限信息请参考<a href="https://docs.volcengine.com/docs/82379/2333565#617ff561">怎样管理用户对素材库的权限？</a></div>
...
1. [CreateAssetGroup](https://docs.volcengine.com/docs/82379/2318270)：创建素材资产组合。

2. [CreateAsset](https://docs.volcengine.com/docs/82379/2318271)：创建素材资产。该接口可用于上传个人素材资产，创建素材资产后可利用返回字段中的素材 Id （需处于 `Active` 状态）用于 Seedance 2.0 和 Seedance 2.5 模型生成视频。
...
> 素材格式的具体要求，请参考[素材资产库结构说明](https://docs.volcengine.com/docs/82379/2333565#2b7bf522)。


1. 打开 [方舟控制台](https://console.volcengine.com/ark/region:cn-beijing/experience/vision?modelId=doubao-seedance-2-0-260128&tab=GenVideo) \> **我的** \> **虚拟人像**。
...
* <div data-tips="true" data-tips-type="tip">API 参数信息请参考<a href="https://docs.volcengine.com/docs/82379/2333601">私域虚拟人像库 API 参考文档</a>。</div>


* <div data-tips="true" data-tips-type="tip"><strong>素材库</strong><a href="https://docs.volcengine.com/docs/82379/1359411#03ec4a65"><strong>项目</strong></a><strong>（Project）隔离说明</strong></div>
...
* **ProjectName**：选填，指定资源项目名称，默认为 default。一个项目中的资源仅可被该项目下的推理接入点使用，获取项目名称请参考 [文档](https://docs.volcengine.com/docs/82379/1359411#03ec4a65)。
...
* **AssetType**: 必填，支持上传图片/视频/音频类型素材，需指定为 **Image/Video/Audio**。素材文件的具体限制详见 [Assets API 参考文档](https://docs.volcengine.com/docs/82379/2318271) **。** 
...
<div data-tips="true" data-tips-type="tip">该字段仅用于使用 ListAssets 接口时模糊搜索素材，不会被带入模型推理。关于如何使用素材生成视频，请参考<a href="https://docs.volcengine.com/docs/82379/2608626#preset-avatar">使用预置虚拟人像</a> 和<a href="https://docs.volcengine.com/docs/82379/2333565#15e21eb8">提示词（content.text）中应该如何准确指代参考素材？</a>。</div>
...
* **控制台**：您可在 [方舟控制台](https://console.volcengine.com/ark/region:cn-beijing/experience/vision?modelId=doubao-seedance-2-0-260128&tab=GenVideo) \> **我的** \> **虚拟人像** 中搜索和查看已上传的虚拟人像资产。
...
<div data-tips="true" data-tips-type="tip">要获取完整的 API 参数、限流等信息，请查看<a href="https://docs.volcengine.com/docs/82379/2333601">私域虚拟人像库 API 参考文档</a>。</div>
...
<div data-tips="true" data-tips-type="tip">ListAssets 支持 NextToken 分页和页码分页。分页方式、参数用法及使用限制，请参见 <a href="https://docs.volcengine.com/docs/82379/2318273">ListAssets API 参考文档</a>。</div>
...
<div data-tips="true" data-tips-type="tip">ListAssetGroups 支持 NextToken 分页和页码分页。分页方式、参数用法及使用限制，请参见 <a href="https://docs.volcengine.com/docs/82379/2318272">ListAssetGroups API 参考文档</a>。</div>
    ...
    resp, err := universal.New(sess).DoCall(
        ...
        &map[string]any{
            "Filter": map[string]any{
                ...
                "GroupIds":  []string{"group-20260318033332-*****", "group-20260318033410-*****"},
                "GroupType": "AIGC",
            },
            "MaxResults": 1,
            "SortBy":     "CreateTime",
...
您可调用 `UpdateAsset`、`UpdateAssetGroup`、`DeleteAsset` 和 `DeleteAssetGroup` 更新或删除素材及素材组。具体信息请参考：[私域虚拟人像库 API 参考文档](https://docs.volcengine.com/docs/82379/2333601)。
...
3. 根据 Status 判断
   ...
   * Active → 返回 URL（结束）状态为 `Active` 后，可使用该素材 Asset ID (URI格式) 进行视频生成，如何使用人像素材生成视频，详见[使用预置虚拟人像](https://docs.volcengine.com/docs/82379/2608626#preset-avatar)。
...
具体方式请参考 [Seedance 2.0 教程](https://docs.volcengine.com/docs/82379/2291680) 和 [Seedance 2.0 API 参考](https://docs.volcengine.com/docs/82379/1520757)。
...
<div data-tips="true" data-tips-type="tip">调用示例请参考<a href="https://docs.volcengine.com/docs/82379/2333565#15e21eb8">提示词（content.text）中应该如何准确指代参考素材？</a></div>
...
素材库按 [项目](https://docs.volcengine.com/docs/82379/1359411#03ec4a65) **（Project）隔离**。
...
关于 IAM 的更多信息，请参考 [访问控制](https://www.volcengine.com/docs/6257?lang=zh)。
