# 产品参考图：Preview 与正式确认接口手册

需求依据：[统一规范 v1.1](../requirements/2026-09-14/workflow-preview-production-spec.md)。当前实现、是否部署与验证结果以 [PROJECT_STATUS](../PROJECT_STATUS.md) 为准。本手册不表示正式服务器已升级；部署排期见 [ROADMAP](../ROADMAP.md)。
...
1. 配置个人凭证，选择静态 PNG/JPEG/WebP 产品图与提示词；首条模板限定 5 秒、720p、16:9。
